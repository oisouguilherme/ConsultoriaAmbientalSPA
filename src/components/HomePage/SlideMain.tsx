      ...
      <div className="bg-green-800 bg-opacity-90 py-32">
        <div className="max-w-6xl px-4 mx-auto gap-12 grid md:grid-cols-2">
          <div className="flex flex-col items-start">
            <p className="text-lg">Olá! Sou <span className="font-medium">Edivaldo Antonio Dourado da Silva</span>, um apaixonado por conservação ambiental e sustentabilidade.</p>
